...
function Search() {
  return (
    <div class="relative flex flex-col justify-center overflow-hidden mb-5 md:mb-0">
    <div class="relative rounded-2xl bg-white shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg ">
      <div class="mx-auto max-w-md">
        <form action="" class="relative mx-auto w-max">
          <input type="search" class="text-black peer relative z-10 h-12 w-12 cursor-pointer rounded-full border bg-transparent pl-12 outline-none focus:w-full focus:cursor-text focus:border-black-300 focus:pl-16 focus:pr-4" />
